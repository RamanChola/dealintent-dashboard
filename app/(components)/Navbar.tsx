        ...
        <nav className="nav-container top-0 ml-30">
            <div id="navbar">
                ...
                <ul className={isNavOpen ? "nav-menu active" : "nav-menu"}>
                    <li className="justify-start content-center w-full h-[80px] hidden md:flex">
                    ...
                    <hr className="border-gray-200 w-[80%] xs:ml-[40px] xs:mr-0 hidden md:block self-start"></hr>
                    <li className='md:flex md:justify-start md:content-center md:w-full md:h-[40px]  md:m-[10px]'>
                        <a href="#" className="nav-links ml-[50px]">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                            </svg>
                            <p className=' text-lg text-[--title] font-sans	tracking-normal	normal-case	hidden md:flex'>Search</p>
                        </a>
                    </li>
                    <hr className="border-gray-200 w-[80%] xs:ml-[40px] xs:mr-0 hidden md:block self-start"></hr>
                    <li className='md:flex md:justify-start md:content-center md:w-full md:h-[40px] md:m-[10px]'>
                        <a href="#" className="nav-links md:ml-[50px]">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859m-19.5.338V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 00-2.15-1.588H6.911a2.25 2.25 0 00-2.15 1.588L2.35 13.177a2.25 2.25 0 00-.1.661z" />
                            </svg>
                            <p className='text-lg text-[--title] font-sans	tracking-normal	normal-case	hidden md:flex'>Inbox</p>
                        </a>
                    </li>
                    <hr className="border-gray-200 w-[80%] xs:ml-[40px] xs:mr-0 hidden md:block self-start"></hr>
                    <li className='md:flex md:justify-start md:content-center md:w-full md:h-[40px] md:m-[10px]'>
                        <a href="#" className="nav-links md:ml-[50px]">
                            ...
                            <p className=' text-lg text-[--title] font-sans	tracking-normal	normal-case	hidden md:flex'>Notifications</p>
                        </a>
                    </li>
                    <hr className="border-gray-200 w-[80%] xs:ml-[40px] xs:mr-0 hidden md:block self-start"></hr>
                    <li className='md:flex md:justify-start md:content-center md:w-full md:h-[40px] md:m-[10px]'>
                        <a href="#" className="nav-links md:ml-[50px]">
                            ...
                            <p className=' text-lg text-[--title] font-sans	tracking-normal	normal-case	hidden md:flex'>Help</p>
                        </a>
                    </li>
                    <hr className="border-gray-200 w-[80%] xs:ml-[40px] xs:mr-0 hidden md:block self-start"></hr>
                    <li>
                        <a href="#" className="nav-links">
                            <div className="w-8 h-8 rounded-full ">
                                <Image src={ProfilePic} className="rounded-full md:hidden" alt="Profile picture" />
                            </div>
                        </a>
                    </li>
                </ul>
